...
/**
 * Unit and integration tests targeting previously-uncovered paths in Hegel.java.
 * Uses Hegel.testSession injection and direct method calls on package-private methods.
 */
class HegelUnitTest {
    ...
    void checkResultsHealthCheckFailure() {
        ...
        AssertionError ex = assertThrows(AssertionError.class,
            () -> hegel().checkResults(result, null));
    ...
    void checkResultsPassedFalseWithCapture() {
        ...
        AssertionError thrown = assertThrows(AssertionError.class,
            () -> hegel().checkResults(result, failure));
    ...
    /**
     * Inject a fake Session with a dead connection (server has exited).
     * run() will fail at controlStream.sendRequest() → IOException → lines 137-138.
     * Also covers line 96 (testSession != null branch).
     */
    @Test
    ...
    /**
     * Inject a fake Session whose fake server sends an unknown event type.
     * runEventLoop() throws IOException("Unknown event type") → lines 137-138 + 208.
     */
    @Test
    ...
    void runWithNonEmptyDatabaseCoversDbBranch() {
        ...
        assertDoesNotThrow(() ->
            Hegel.test("hegel unit test non-empty db",
                Settings.builder()
                    .testCases(5)
    ...
    void testBodyThrowsRuntimeExceptionWrappedAsAssertionError() {
        ...
        AssertionError ex = assertThrows(AssertionError.class, () ->
            Hegel.test("unit test runtime exception",
