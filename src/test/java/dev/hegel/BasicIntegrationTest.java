...
/**
 * Basic integration tests that verify the core Hegel functionality
 * by running actual property tests against the hegel-core server.
 */
class BasicIntegrationTest {

    @Test
    void integersAreIntegers() {
        Hegel.test("integers are integers", tc -> {
    ...
    void booleansAreBoolean() {
        Hegel.test("booleans are boolean", tc -> {
    ...
    void listsHaveCorrectSize() {
        Hegel.test("lists have correct size", tc -> {
    ...
    void assumeFiltersTestCases() {
        Hegel.test("assume filters test cases", tc -> {
    ...
    void reverseReverseIsIdentity() {
        Hegel.test("reverse of reverse is identity",
    ...
    void propertyTestCatchesBug() {
        ...
        assertThrows(AssertionError.class, () ->
            Hegel.test("buggy sort", Settings.builder().testCases(200).build(), tc -> {
    ...
    void sampledFromPicks() {
        Hegel.test("sampledFrom picks from list", tc -> {
    ...
    void mapsHaveCorrectKeys() {
        Hegel.test("maps have correct key types", tc -> {
    ...
    void floatsAreFiniteWhenBounded() {
        Hegel.test("floats with bounds are finite", tc -> {
