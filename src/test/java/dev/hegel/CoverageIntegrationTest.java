...
/**
 * Integration tests targeting uncovered code paths. All tests use the real
 * hegel-core server. Exercises format generators, combinators, non-basic
 * generator paths, error injection, and various Settings configurations.
 */
class CoverageIntegrationTest {
    ...
    void binaryGeneratesBytes() {
        Hegel.test("binary generates bytes", tc -> {
    ...
    void binaryWithSizeConstraints() {
        Hegel.test("binary with size constraints", tc -> {
    ...
    void justAlwaysReturnsConstant() {
        Hegel.test("just always returns constant", tc -> {
    ...
    void textWithMinSize() {
        Hegel.test("text with min size", tc -> {
    ...
    void textWithMaxSize() {
        Hegel.test("text with max size", tc -> {
    ...
    @Test
    void textWithCodec() {
        Hegel.test("text with explicit codec", tc -> {
    ...
    void integersTwoArgConvenience() {
        Hegel.test("integers(min, max)", tc -> {
    ...
    void integersOnlyMinSet() {
        Hegel.test("integers with only min", tc -> {
    ...
    void integersOnlyMaxSet() {
        Hegel.test("integers with only max", tc -> {
    ...
    void integersMinValueGreaterThanMaxThrows() {
        assertThrows(IllegalArgumentException.class, () ->
            integers().minValue(10).maxValue(5)
                .generate(new TestCase(null, false))
        );
    }
    ...
    void floatsAllowNanExplicit() {
        Hegel.test("floats with allowNan true", Settings.builder().testCases(50).build(), tc -> {
    ...
    void floatsAllowInfinityExplicit() {
        Hegel.test("floats with allowInfinity true", Settings.builder().testCases(50).build(), tc -> {
    ...
    void floatsExcludeMinMax() {
        Hegel.test("floats excludeMin excludeMax", tc -> {
            double d = tc.draw(floats().minValue(0.0).maxValue(1.0)
                .excludeMin(true).excludeMax(true));
    ...
    void filterCombinator() {
        Hegel.test("filter combinator", tc -> {
    ...
    void mapOnNonBasicGenerator() {
        Hegel.test("map on non-basic generator", tc -> {
    ...
    void oneOfWithNonBasicGenerator() {
        ...
        Hegel.test("oneOf with non-basic", tc -> {
    ...
    void optionalGenerator() {
        Hegel.test("optional generator", Settings.builder().testCases(50).build(), tc -> {
    ...
    void sampledFromList() {
        ...
        Hegel.test("sampledFrom list", tc -> {
    ...
    void listsWithNonBasicElements() {
        ...
        Hegel.test("lists non-basic elements", tc -> {
    ...
    void listsNonBasicWithSizeConstraints() {
        Hegel.test("lists non-basic with size", tc -> {
            List<Long> xs = tc.draw(
                lists(integers(0, 10).filter(n -> n >= 0)).minSize(1).maxSize(5)
            );
    ...
    void mapsWithNonBasicValues() {
        ...
        Hegel.test("maps non-basic values", tc -> {
            Map<Long, Long> m = tc.draw(
                maps(integers(0, 10), integers(0, 100).filter(v -> v >= 0))
            );
    ...
    void mapsWithSizeConstraints() {
        Hegel.test("maps with size constraints", tc -> {
            Map<Long, Long> m = tc.draw(
                maps(integers(0, 100), integers(0, 100)).minSize(1).maxSize(3)
            );
    ...
    void emailsGenerator() {
        Hegel.test("emails", Settings.builder().testCases(20).build(), tc -> {
    ...
    @Test
    void urlsGenerator() {
        Hegel.test("urls", Settings.builder().testCases(20).build(), tc -> {
    ...
    void domainsGenerator() {
        Hegel.test("domains", Settings.builder().testCases(20).build(), tc -> {
    ...
    void ipv4AddressesGenerator() {
        Hegel.test("ipv4", Settings.builder().testCases(20).build(), tc -> {
    ...
    void ipv6AddressesGenerator() {
        Hegel.test("ipv6", Settings.builder().testCases(20).build(), tc -> {
    ...
    void ipAddressesGenerator() {
        Hegel.test("ip addresses", Settings.builder().testCases(20).build(), tc -> {
    ...
    @Test
    void datesGenerator() {
        Hegel.test("dates", Settings.builder().testCases(20).build(), tc -> {
    ...
    @Test
    void timesGenerator() {
        Hegel.test("times", Settings.builder().testCases(20).build(), tc -> {
    ...
    void datetimesGenerator() {
        Hegel.test("datetimes", Settings.builder().testCases(20).build(), tc -> {
    ...
    void fromRegexGenerator() {
        Hegel.test("fromRegex", Settings.builder().testCases(20).build(), tc -> {
    ...
    void fromRegexFullmatch() {
        Hegel.test("fromRegex fullmatch", Settings.builder().testCases(20).build(), tc -> {
    ...
    void settingsWithSeed() {
        ...
        Hegel.test("with seed", Settings.builder().testCases(10).seed(42L).build(), tc -> {
    ...
    void settingsWithDatabaseDisabled() {
        Hegel.test("database disabled", Settings.builder().testCases(10).database("").build(), tc -> {
    ...
    void settingsWithDerandomize() {
        Hegel.test("derandomize", Settings.builder().testCases(10).derandomize(true).build(), tc -> {
            long x = tc.draw(integers());
        });
    }
    ...
    void settingsWithSuppressHealthCheck() {
        Hegel.test("suppress health check", Settings.builder()
            .testCases(10)
    ...
    void noteIsCalledDuringInterestingReplay() {
        ...
        assertThrows(AssertionError.class, () ->
            Hegel.test("note in final replay", Settings.builder().testCases(100).build(), tc -> {
    ...
    void targetDoesNotBreakTest() {
        Hegel.test("target hint", Settings.builder().testCases(20).build(), tc -> {
            long x = tc.draw(integers(0, 100));
    ...
    void hegelBuilderDatabaseKey() {
        ...
        new Hegel(tc -> {}).databaseKey("custom_key").settings(Settings.builder().testCases(5).build()).run();
    }
}
