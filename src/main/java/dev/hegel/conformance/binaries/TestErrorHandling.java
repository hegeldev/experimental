 ...
 *
 * <p>Used for: stop_test_on_generate, stop_test_on_mark_complete,
 * stop_test_on_collection_more, stop_test_on_new_collection,
 * error_response, empty_test.
 *
 * <p>The binary runs a simple integer generator test.
 * The HEGEL_PROTOCOL_TEST_MODE env var is set by the conformance framework
 * to inject specific error conditions. The binary must exit cleanly (exit code 0).
 */
public class TestErrorHandling {
    public static void main(String[] args) {
        ...
        try {
            Hegel.test("error_handling", Settings.builder().testCases(testCases).build(), tc -> {
