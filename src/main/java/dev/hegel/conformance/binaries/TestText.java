...
import static dev.hegel.generators.Generators.text;
...
public class TestText {
    public static void main(String[] args) {
        ...
        dev.hegel.BasicGenerator<String> gen = new dev.hegel.BasicGenerator<>(schema, node -> {
        ...
        Hegel.test("text", Settings.builder().testCases(testCases).build(), tc -> {
