 ...
 *
 * <p>Passed to {@code Hegel.test()} functions and provides methods
...
public class TestCase {
     ...
     *
     * <p>This tells the engine that these particular inputs are not interesting,
     * without counting them as a test failure. The engine will try different inputs.
     */
    ...
    /**
     * Print a message, but only during the final (shrunk) replay of a failing test case.
     * Use this for debugging counterexamples.
     */
    ...
    /**
     * Guide the engine toward higher values of the given metric.
     * The engine will try to maximize {@code value}.
     *
    ...
    /**
     * Send a CBOR schema and receive the raw generated value.
     * Called by {@link BasicGenerator#generate(TestCase)}.
     */
