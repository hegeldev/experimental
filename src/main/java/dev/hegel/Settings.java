 ...
 *
 * <p>Obtain via the builder: {@code Settings.builder().testCases(200).build()}. For default
 * settings use {@link #defaults()}.
 */
public final class Settings {
  ...
  public List<String> suppressHealthCheck() {
    return suppressHealthCheck;
  }
