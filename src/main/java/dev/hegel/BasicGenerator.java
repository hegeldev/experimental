 ...
 * <ul>
 *   <li>A <em>raw schema</em>: sent to the server to generate a raw value.</li>
 *   <li>An optional <em>transform</em>: applied client-side to the raw server value.</li>
 * </ul>
 *
 * <p>Applying {@link #map(java.util.function.Function)} to a basic generator preserves
 * basic-ness: the new transform is the composition of the existing transform and the
 * mapping function, and the schema is unchanged.
 *
...
public class BasicGenerator<T> implements Generator<T> {
    ...
    /**
     * Create a basic generator with a schema and identity transform.
     * The {@link #generate} method will return the raw server value cast to {@code T}.
     */
    ...
    /**
     * Create a new basic generator that applies {@code f} after this generator's transform.
    ...
    /**
     * Convert a {@link JsonNode} to a plain Java object.
     * Used by identity-transform basic generators.
     */
