 ...
 *
 * <p>A background reader thread reads all incoming packets and dispatches them to the appropriate
 * stream's queue. Writes are serialized via a mutex.
 */
public class Connection {

  public static final String SERVER_CRASHED_MESSAGE = "hegel-core server has exited unexpectedly";
