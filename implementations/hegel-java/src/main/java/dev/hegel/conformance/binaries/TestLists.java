...
public class TestLists {
  public static void main(String[] args) {
    ...
    Integer maxSize =
        params.has("max_size") && !params.get("max_size").isNull()
            ? params.get("max_size").asInt()
            : null;
    Long minValue =
        params.has("min_value") && !params.get("min_value").isNull()
            ? params.get("min_value").longValue()
            : null;
    Long maxValue =
        params.has("max_value") && !params.get("max_value").isNull()
            ? params.get("max_value").longValue()
            : null;
