...
conformance:
    timeout 240 uv run --with 'hegel-core==0.4.1' --with pytest --with hypothesis --with pytest-subtests --with pytest-timeout \
        pytest conformance/tests/test_conformance.py -v --timeout=60 || true
